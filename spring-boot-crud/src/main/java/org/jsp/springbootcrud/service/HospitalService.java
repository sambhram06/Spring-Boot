...
public class HospitalService {
	...
	public ResponseEntity<ResponseStructure<Hospital>> findById(int id){
		...
		structure.setData(null);
		structure.setMessage("Cannot Find Hospital as id is Invalid");
		structure.setStatusCode(HttpStatus.NOT_FOUND.value());
		return ResponseEntity.status(HttpStatus.NOT_FOUND).body(structure);
	} 
	...
	public ResponseEntity<ResponseStructure<String>> deleteHospital(int id){
		...
		structure.setData(null);
		structure.setMessage("Cannot find Hospital Data as Id is Invalid");
		structure.setStatusCode(HttpStatus.NOT_FOUND.value());
		return ResponseEntity.status(HttpStatus.NOT_FOUND).body(structure);
	}
	...
	public ResponseEntity<ResponseStructure<List<Hospital>>> findByAdminId(int admin_id){
		...
		if(hospitals.isEmpty()) {
			structure.setMessage("No Hospital found for entered Admin_id");
		}
		else 
			structure.setMessage("List of Admins for Enterede Admin_id");
			structure.setStatusCode(HttpStatus.OK.value());
			return ResponseEntity.status(HttpStatus.OK).body(structure);
	}
